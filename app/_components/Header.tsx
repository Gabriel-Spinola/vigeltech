...
export default async function Header({ locale }: { locale: ImplLocale }) {
  ...
  return (
    <>
      <header
        className={`min-h-[100vh] md:min-h-[111vh] bg-office-work bg-bottom bg-no-repeat bg-cover py-20 md:py-8 lg:px-32 lg:py-16 ${styles.header}`}
      ...
      >
        ...
        >
          ...
          <section className="flex flex-col w-full gap-24 font-bold">
            <nav className="hidden md:flex flex-row gap-16 lg:gap-32 text-lightblue font-bold w-full justify-center text-lg lg:text-2xl">
            ...
            <h1
              className={`${styles.headerTitle} drop-shadow-lg text-[#fff] text-6xl lg:text-8xl text-left md:text-center`}
            >
